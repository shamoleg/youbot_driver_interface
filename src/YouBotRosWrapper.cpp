...
WrapperYouBotDriverBase::WrapperYouBotDriverBase(std::string baseName, std::string configFilePath){
    try{
...
void WrapperYouBotDriverBase::setVelocity(BaseVelocity velocity)
{
...
BaseVelocity WrapperYouBotDriverBase::getVelocity()
{
    ...
    return {velocityX.value(), velocityY.value(), velocityWZ.value()};
}

void WrapperYouBotDriverBase::setPosition(BasePosition position)
{
...
void WrapperYouBotDriverBase::setJointState(JointState jointState)
{
